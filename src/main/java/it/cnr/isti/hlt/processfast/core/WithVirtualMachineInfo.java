...
/**
 * Information to be used with {@link it.cnr.isti.hlt.processfast.core.TaskDescriptor#onVirtualMachine(it.cnr.isti.hlt.processfast.utils.Function1)}
 *
 * @author Tiziano Fagni (tiziano.fagni@isti.cnr.it)
 * @since 1.0.0
 */
public interface WithVirtualMachineInfo extends TaskIdentifier {
